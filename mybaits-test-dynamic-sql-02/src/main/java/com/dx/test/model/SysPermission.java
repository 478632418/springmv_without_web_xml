...
public class SysPermission {
	...
	public SysPermission(Long id, String permissionName, String permissionValue) {
		super();
		this.id = id;
	...
	public SysPermission(Long id, String permissionName, String permissionValue, Date createTime, String createUser,
